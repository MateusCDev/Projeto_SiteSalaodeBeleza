    ...
    <head>
        ...
        <body class="fundo">
            ...
            <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                            $sql ="select VE.idvenda AS ID, VE.dat AS DATA, VE.quantidade AS QUANTIDADE, CLI.nome AS 'Nome do Cliente', FUNC.nomef AS 'Nome do Funcionario', SERV.descricao AS Descricao 
                            FROM venda VE
                            INNER JOIN cliente CLI ON CLI.idcliente = VE.idcliente
                            INNER JOIN funcionario FUNC ON FUNC.idfuncionario = VE.idfuncionario
                            INNER JOIN servico SERV ON SERV.idservico = VE.idservico ";
                        ...
                        <tr class="gradeX">
                            ...
                            <td><?php echo($rs['Nome do Funcionario']); ?></td>
                            <td>
                                <center>
                                    <a href="#"> 
